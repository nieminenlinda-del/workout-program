...
7. **Save** — notes, persist `SessionLog` in IndexedDB behind a repository interface. **Session log** lists saved days, exports/imports JSON, can restore Week 1 weights so Last: works on this install, and can restore a reconstructed Mon 14 Day A (squat 57.5×3×4 @7, RDL 50×8×3 @6, reverse lunge 37.5×8×3 @7, plank 5 kg). There is no server backup.

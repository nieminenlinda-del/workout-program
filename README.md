...
7. **Save** — notes, persist `SessionLog` in IndexedDB behind a repository interface. **Session log** lists saved days, exports/imports JSON, and can seed a Week 1 Last: reference.

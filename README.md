...
1. **Today** — default **Monday / Day A** squat template. Pick A–D (Mon/Tue/Thu/Fri). Block A T1s follow the Kraft week table (Week 2 squat **57.5 × 3×4**; bench/DL hold load). The collapsed preview shows **work kg** (`57.5 kg · 3 × 4`) plus last week’s top work set (`Last: 47.5 kg × 5`) from completed logs — Start is not required.
